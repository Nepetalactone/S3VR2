...
public class ImageDetectionFilterOld implements Filter {
	...
	public ImageDetectionFilterOld(final Context context, final int referenceImageResourceID) throws IOException {
