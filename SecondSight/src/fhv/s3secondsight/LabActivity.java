...
public class LabActivity extends Activity {
	...
	public static final String EXTRA_PHOTO_URI = "fhv.s3secondsight.LabActivity.extra.PHOTO_URI";
	public static final String EXTRA_PHOTO_DATA_PATH = "fhv.s3secondsight.LabActivit.extra.PHOTO_DATA_PATH";
	private Uri mUri;
	...
	private void deletePhoto() {
		...
		alert.setPositiveButton(R.string.delete, new DialogInterface.OnClickListener() {
			...
			public void onClick(final DialogInterface dialog, final int which) {
				getContentResolver().delete(Images.Media.EXTERNAL_CONTENT_URI, MediaStore.MediaColumns.DATA + "=?", 
